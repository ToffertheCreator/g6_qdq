...
from algorithms.binarysearchtree import BinarySearchTree
import os
...
def bst():
    ...
    def restore():
        ...
        bt = BinarySearchTree()  # Create empty tree from BST module
    ...
    if request.method == "POST":
        ...
        # Max value
            ...
            if bt:
                max_result = bt.get_max_value(bt.root)
            else:
                message = "Tree is empty"
        ...
        # Min value
            ...
            if bt:
                min_result = bt.get_min_value(bt.root)
            else:
                message = "Tree is empty"
        ...
        # Traversals
            ...
            if not bt:
                ...
                if op == "preorder_traversal":
                    ...
                    traversal_result = "Postorder: " + bt.post_traversal(bt.root)
